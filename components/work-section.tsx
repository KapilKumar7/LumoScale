...
const projects = [
  {
    ...
    description: 'An advanced conversational AI platform with natural language processing capabilities for customer support automation.',
    category: ['ai', 'web'],
    image: 'https://images.pexels.com/photos/7567565/pexels-photo-7567565.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
  ...
  },
  {
    ...
    description: 'A comprehensive financial tracking application with expense management, budgeting, and investment portfolio tracking.',
    category: ['mobile'],
  ...
  },
  {
    ...
    description: 'A robust cloud infrastructure monitoring and management dashboard for DevOps teams with real-time analytics.',
    category: ['cloud', 'web'],
    image: 'https://images.pexels.com/photos/8106763/pexels-photo-8106763.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
  ...
  },
  {
    ...
    description: 'An integrated healthcare platform connecting patients with providers through secure video consultations and record sharing.',
    category: ['web', 'mobile'],
  ...
  },
  {
    ...
    description: 'AI-powered retail analytics system for inventory management, customer behavior analysis, and sales forecasting.',
    category: ['ai', 'cloud'],
  ...
  },
  {
    ...
    description: 'Environmental monitoring platform using IoT sensors to track air quality, water levels, and climate conditions.',
    category: ['cloud', 'web'],
    ...
    <section id="work" className="py-24">
      <div className="container mx-auto px-4">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                      ...
                      <div className="flex flex-wrap gap-2 mb-2">
                        {project.technologies.map((tech, index) => (
                          <span key={index} className="text-xs font-medium bg-white/20 backdrop-blur-sm rounded-full px-2 py-1">
                            {tech}
                          </span>
                        ))}
                      </div>
        ...
        <div className="text-center mt-12">
          <Button asChild variant="outline" size="lg" className="border-blue-600 dark:border-blue-400 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-950/50">
