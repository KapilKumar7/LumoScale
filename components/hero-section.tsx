        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-xl mt-4">
              We craft exceptional digital experiences with cutting-edge
              technology and drive growth through strategic digital marketing.
              From DevOps to AI and SEO/ASO, we bring your vision to life.
            </p>
          ...
          >
            {/*
            <div className="relative z-10 bg-white/10 dark:bg-white/5 backdrop-blur-sm border border-white/20 dark:border-white/10 rounded-2xl p-1 shadow-xl">
