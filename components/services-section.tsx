...
const services = [
  {
    ...
    description:
      "Streamline your development and operations with our enterprise-grade CI/CD pipelines, container orchestration, and cloud infrastructure management.",
    features: [
  ...
  },
  {
    ...
    description:
      "Build stunning, high-performance mobile apps for iOS and Android from a single codebase with our React Native expertise.",
    features: [
  ...
  },
  {
    ...
    description:
      "End-to-end web application development with modern frameworks, scalable architecture, and seamless integration capabilities.",
    features: [
      "Frontend Excellence",
  ...
  },
  {
    ...
    description:
      "Harness the power of artificial intelligence with custom solutions for automation, data analysis, and intelligent decision-making.",
    features: [
  ...
  },
  {
    ...
    description:
      "Enhance customer engagement with intelligent conversational interfaces that integrate seamlessly with your existing platforms.",
    features: [
  ...
  },
  {
    ...
    description:
      "Amplify your reach and drive growth with our comprehensive digital marketing solutions, including SEO, ASO, PPC, and content strategy.",
    features: [
      "SEO & ASO",
    ...
    color: "yellow",
    bgGradient: "from-yellow-600/20 to-yellow-400/5",
  },
  {
    id: "consulting",
    ...
    icon: <MessageSquare className="h-6 w-6" />,
    description:
      "Expert guidance to navigate your digital transformation journey, from ideation to implementation and scaling.",
    features: [
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-12">
          ...
          >
            ...
            specific needs, helping businesses transform their digital presence.
          </motion.p>
        </div>
        ...
        <div className="mt-20 grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            <p className="text-muted-foreground">
              Build systems that grow with your business, from startup to
              enterprise scale.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-muted-foreground">
              Tailor-made solutions aligned perfectly with your unique business
              requirements.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-muted-foreground">
              Efficient storage, processing, and analysis of your most valuable
              asset: your data.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-muted-foreground">
              Harness the full power of cloud computing for flexibility,
