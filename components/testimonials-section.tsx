...
const testimonials = [
  {
    ...
    quote: 'LumoScale transformed our outdated systems into a modern, scalable platform. Their expertise in DevOps and cloud architecture saved us countless hours and significantly improved our deployment process.',
  ...
  },
  {
    ...
    quote: 'The mobile app LumoScale built for us exceeded all expectations. The team\'s attention to detail and commitment to quality resulted in a product our users love. Their React Native expertise is unmatched.',
  ...
  },
  {
    ...
    quote: 'Integrating AI into our platform seemed daunting until we partnered with LumoScale. Their team made the process seamless, delivering an intelligent solution that has revolutionized our customer service.',
  ...
  },
  {
    ...
    quote: 'The custom chatbot developed by LumoScale has dramatically improved our customer engagement metrics. Their understanding of both technology and business objectives made them the perfect partner.',
  ...
  },
  {
    ...
    quote: 'Working with LumoScale on our full-stack application was a game-changer for our business. Their technical expertise combined with strategic thinking helped us launch faster than expected.',
    ...
    <section id="testimonials" className="py-24 bg-secondary/50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          >
            Our success is measured by our clients' satisfaction. Here's what they have to say about working with us.
          </motion.p>
        </div>
              ...
              {testimonials.map((_, index) => (
                <span
                  ...
                  className={`block h-2 w-2 rounded-full ${
                    activeIndex === index ? 'bg-blue-600 dark:bg-blue-400' : 'bg-gray-300 dark:bg-gray-700'
                  }`}
                />
              ))}
            </div>
